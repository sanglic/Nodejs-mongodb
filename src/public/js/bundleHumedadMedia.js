...
graph("Temperatura_Humedad_15_metros_media.csv")
//graph("Temperatura_Humedad_4_metros_media.csv")
...
var svg = d3.select("#grafica")
  ...
  .append("g")
    ...
    svg.append("text")
        ...
        .text("Temperatura Humedad 15 metros media" )
        .style("color","#008B8B");
...
d3.csv("./data/"+valor_csv,
  ...
  function(d){
    return { date : d3.timeParse("%Y-%m-%d")(d.date), RH : Number(d.RH), Tair: Number(d.Tair)}
