...
d3.csv("./data/Radiacion.csv",
  ...
  function(d){
    return { date : d3.timeParse("%Y-%m-%d %H:%M:%S")(d.date), LW_in_Avg : Number(d.LW_in_Avg), LW_out_Avg: Number(d.LW_out_Avg)}
 ...
 // add the Y gridlines
    ...
    svg.on("dblclick",function(){
	 ...
	 line2.selectAll("dot")  //Selecccionamos los puntos de la linea
        ...
        .attr("cy", function(d) { return z(d.LW_out_Avg);})   
        .on("mouseover", function(d) {                         //añadimos la cajita cada vez que pasamos el ratón
            div.transition()    
                .duration(200)    
                .style("opacity", 1);    
            div .html((d.date) + "<br/>"+"LW_in_Av: "+d.LW_in_Avg+"<br/>"+"LW_out_Avg: " + d.LW_out_Avg)  
        ...
        .attr("r", 3)   
        .attr("cx", function(d) { return x(d.date); })     
        .attr("cy", function(d) { return y(d.LW_in_Avg); })
        .attr("cz", function(d) { return z(d.LW_out_Avg); })   
        .on("mouseover", function(d) {                         //añadimos la cajita cada vez que pasamos el ratón
            div.transition()    
                .duration(200)    
                .style("opacity", 1);    
            div .html((d.date) + "<br/>"+"LW_in_Avg: "+d.LW_in_Avg+"<br/>"+"LW_out_Avg: " + d.LW_out_Avg)  
                .style("left", (d3.event.pageX-100)+ "px")   
                .style("top", (d3.event.pageY - 100) + "px")
                .style("color","#008B8B")
                .style("opacity", 1);
